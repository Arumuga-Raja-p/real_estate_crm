...
-- Tower A - Azure
('aaaaaaaa-0101-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'A-101', '1BHK', 1, 750, 240000, 'Available'),
('aaaaaaaa-0102-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'A-102', '2BHK', 1, 1150, 380000, 'Available'),
('aaaaaaaa-0201-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'A-201', '2BHK', 2, 1200, 395000, 'Available'),
('aaaaaaaa-0401-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'A-401', '3BHK', 4, 1850, 620000, 'Available'),
('aaaaaaaa-1201-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'A-1201', '3BHK', 12, 1920, 710000, 'Available'),
('aaaaaaaa-2401-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'A-PH01', 'Penthouse', 24, 3400, 1450000, 'Available'),

-- Tower B - Coral
('aaaaaaaa-0101-2222-2222-222222222222', 'bbbbbbbb-2222-2222-2222-222222222222', 'B-101', '1BHK', 1, 720, 230000, 'Available'),
('aaaaaaaa-0301-2222-2222-222222222222', 'bbbbbbbb-2222-2222-2222-222222222222', 'B-301', '2BHK', 3, 1180, 385000, 'Available'),
('aaaaaaaa-0501-2222-2222-222222222222', 'bbbbbbbb-2222-2222-2222-222222222222', 'B-501', '3BHK', 5, 1750, 590000, 'Available'),

-- Pinnacle Tower
('aaaaaaaa-1001-3333-3333-333333333333', 'bbbbbbbb-3333-3333-3333-333333333333', 'P-1001', '2BHK', 10, 1250, 480000, 'Available'),
('aaaaaaaa-2001-3333-3333-333333333333', 'bbbbbbbb-3333-3333-3333-333333333333', 'P-2001', '3BHK', 20, 2100, 890000, 'Available'),
('aaaaaaaa-3201-3333-3333-333333333333', 'bbbbbbbb-3333-3333-3333-333333333333', 'P-PH32', 'Penthouse', 32, 4200, 2100000, 'Available'),

-- Emerald Eco Villas
('aaaaaaaa-0001-4444-4444-444444444444', 'bbbbbbbb-4444-4444-4444-444444444444', 'Villa-01', 'Villa', 1, 3800, 1250000, 'Available'),
('aaaaaaaa-0002-4444-4444-444444444444', 'bbbbbbbb-4444-4444-4444-444444444444', 'Villa-02', 'Villa', 1, 4500, 1600000, 'Available')
ON CONFLICT (id) DO NOTHING;
